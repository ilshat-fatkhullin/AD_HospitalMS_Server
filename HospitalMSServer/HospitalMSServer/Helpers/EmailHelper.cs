...
namespace HospitalMSServer.Helpers
{
    public static class EmailHelper
    {
        ...
        {
            string body = "<a href=\"http://hospitalmanagementsystemforiu.azurewebsites.net/api/authentication/verify?verificationLink=" + verificationLink + "\">click here to verify</a>";
